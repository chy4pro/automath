...
Usage: round6_rank1_jn_singular.py <n> <p> [--wall-build 900] [--wall-msolve 1800] [--rss-mb 1500] [--build-only]"""
...
OUT = "$HOME/workspace/claudecode/automath/engine/harvest/k1695_r6_rank1_n%d" % n; os.makedirs(OUT, exist_ok=True)
