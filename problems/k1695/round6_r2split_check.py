...
OUT = "$HOME/workspace/claudecode/automath/engine/harvest/k1695_r6_r2split_check"
...
json.dump({"results": results, "nonunit": nonunit}, open(OUT + "/summary.json", "w"), indent=1)
