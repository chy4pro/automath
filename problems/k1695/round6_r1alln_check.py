#!/usr/bin/env python3
"""ROUND 6-AV (registry R6.123): my own verification of the load-bearing identities in the K6-R1ALLN harvest
(engine/harvest/k1695_r6_r1alln_pro.md), at dimensions BEYOND the engine's symbolic checker (their m <= 3 resultant,
m <= 6 constant-x):
